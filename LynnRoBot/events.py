...
def load_module(shortname):
    if shortname.startswith("__"):
        ...
        import importlib
        import LynnRoBot.events

        path = Path(f"LynnRoBot/modules/{shortname}.py")
        name = "LynnRoBot.modules.{}".format(shortname)
        ...
        mod.lynnrobot = lynnrobot
        mod.tbot = telethn
        mod.logger = logging.getLogger(shortname)
        spec.loader.exec_module(mod)
        sys.modules["LynnRoBot.modules." + shortname] = mod
        print("Successfully imported " + shortname)


path = "LynnRoBot/modules/*.py"
