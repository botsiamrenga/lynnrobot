...
☞︎︎︎ /math*:* Math `/math 2^2+2(2)`
☞︎︎︎ /factor*:* Factor `/factor x^2 + 2x`
☞︎︎︎ /derive*:* Derive `/derive x^2+2x`
☞︎︎︎ /integrate*:* Integrate `/integrate x^2+2x`
☞︎︎︎ /zeroes*:* Find 0's `/zeroes x^2+2x`
☞︎︎︎ /tangent*:* Find Tangent `/tangent 2lx^3`
☞︎︎︎ /area*:* Area Under Curve `/area 2:4lx^3`
☞︎︎︎ /cos*:* Cosine `/cos pi`
☞︎︎︎ /sin*:* Sine `/sin 0`
☞︎︎︎ /tan*:* Tangent `/tan 0`
☞︎︎︎ /arccos*:* Inverse Cosine `/arccos 1`
☞︎︎︎ /arcsin*:* Inverse Sine `/arcsin 0`
☞︎︎︎ /arctan*:* Inverse Tangent `/arctan 0`
☞︎︎︎ /abs*:* Absolute Value `/abs -1`
☞︎︎︎ /log*:* Logarithm `/log 2l8`
