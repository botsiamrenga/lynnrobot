...
from LynnRoBot.modules.helper_funcs.extraction import extract_user_and_text
from LynnRoBot.modules.helper_funcs.string_handling import extract_time
from LynnRoBot.modules.log_channel import gloggable, loggable
...
__help__ = """
 ☞︎︎︎ /punchme*:* punchs the user who issued the command
*Admins only:*
 ☞︎︎︎ /ban <userhandle>*:* bans a user. (via handle, or reply)
 ☞︎︎︎ /sban <userhandle>*:* Silently ban a user. Deletes command, Replied message and doesn't reply. (via handle, or reply)
 ☞︎︎︎ /tban <userhandle> x(m/h/d)*:* bans a user for `x` time. (via handle, or reply). `m` = `minutes`, `h` = `hours`, `d` = `days`.
 ☞︎︎︎ /unban <userhandle>*:* unbans a user. (via handle, or reply)
 ☞︎︎︎ /punch <userhandle>*:* Punches a user out of the group, (via handle, or reply)
"""
