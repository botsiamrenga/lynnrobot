...
__help__ = """
 ☞︎︎︎ /google <text>*:* Perform a google search
 ☞︎︎︎ /img <text>*:* Search Google for images and returns them\nFor greater no. of results specify lim, For eg: `/img hello lim=10`
 ☞︎︎︎ /app <appname>*:* Searches for an app in Play Store and returns its details.
 ☞︎︎︎ /reverse: Does a reverse image search of the media which it was replied to.
 ☞︎︎︎ Lynn <query>*:* Lynn answers the query
  💡Ex: `Lynn what is Love?`
"""
