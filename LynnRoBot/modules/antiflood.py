...
from LynnRoBot.modules.sql import antiflood_sql as sql
...
will result in restricting that user.
 ...
 ☞︎︎︎ /flood*:* Get the current flood control setting
• *Admins only:*
 ☞︎︎︎ /setflood <int/'no'/'off'>*:* enables or disables flood control
 *Example:* `/setflood 10`
 ☞︎︎︎ /setfloodmode <ban/kick/mute/tban/tmute> <value>*:* Action to perform when user have exceeded flood limit. ban/kick/mute/tmute/tban
• *Note:*
