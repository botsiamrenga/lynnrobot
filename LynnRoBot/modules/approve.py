...
import LynnRoBot.modules.sql.approve_sql as sql
...
*Admin commands:*
☞︎︎︎ /approval*:* Check a user's approval status in this chat.
☞︎︎︎ /approve*:* Approve of a user. Locks, blacklists, and antiflood won't apply to them anymore.
☞︎︎︎ /unapprove*:* Unapprove of a user. They will now be subject to locks, blacklists, and antiflood again.
☞︎︎︎ /approved*:* List all approved users.
☞︎︎︎ /unapproveall*:* Unapprove *ALL* users in a chat. This cannot be undone.
"""
