...
import LynnRoBot.modules.sql.blacklist_sql as sql
from LynnRoBot import dispatcher, LOGGER
...
from LynnRoBot.modules.helper_funcs.extraction import extract_text
from LynnRoBot.modules.helper_funcs.misc import split_message
from LynnRoBot.modules.log_channel import loggable
from LynnRoBot.modules.warns import warn
from LynnRoBot.modules.helper_funcs.string_handling import extract_time
from LynnRoBot.modules.connection import connected
from LynnRoBot.modules.sql.approve_sql import is_approved
from LynnRoBot.modules.helper_funcs.alternate import send_message, typing_action
...
*NOTE*: Blacklists do not affect group admins.
 ☞︎︎︎ /blacklist*:* View the current blacklisted words.
Admin only:
 ☞︎︎︎ /addblacklist <triggers>*:* Add a trigger to the blacklist. Each line is considered one trigger, so using different lines will allow you to add multiple triggers.
 ☞︎︎︎ /unblacklist <triggers>*:* Remove triggers from the blacklist. Same newline logic applies here, so you can remove multiple triggers at once.
 ☞︎︎︎ /blacklistmode <off/del/warn/ban/kick/mute/tban/tmute>*:* Action to perform when someone sends blacklisted words.
"""
