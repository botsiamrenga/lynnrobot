...
__help__ = """
 ☞︎︎︎ /define <text>*:* Type the word or expression you want to search\nFor example /define kill
 ☞︎︎︎ /spell*:* while replying to a message, will reply with a grammar corrected version
 ☞︎︎︎ /synonyms <word>*:* Find the synonyms of a word
 ☞︎︎︎ /antonyms <word>*:* Find the antonyms of a word
"""
