...
from datetime import datetime
water = './LynnRoBot/resources/lynn.jpg'
client = tbot
...
from LynnRoBot.events import load_module
import asyncio
import os
from datetime import datetime
        ...
        try:
            downloaded_file_name = (
                await event.client.download_media(  # pylint:disable=E0602
                    ...
                    "LynnRoBot/modules/",  # pylint:disable=E0602
                )
            )
...
from LynnRoBot import telethn as tbot, OWNER_ID, DEV_USERS
from LynnRoBot.events import register
import os
import asyncio
import os
