...
import LynnRoBot.modules.sql.chatbot_sql as sql
from coffeehouse.api import API
from coffeehouse.exception import CoffeeHouseError as CFError
from coffeehouse.lydia import LydiaAI
from LynnRoBot import AI_API_KEY, OWNER_ID, SUPPORT_CHAT, dispatcher
...
__help__ = f"""
Chatbot utilizes the CoffeeHouse API and allows Lynn to talk and provides a more interactive group chat experience.
*Commands:* 
*Admins only:*
