...
if is_module_loaded(FILENAME):
    ...
    from LynnRoBot import EVENT_LOGS, LOGGER, dispatcher
    from LynnRoBot.modules.helper_funcs.chat_status import user_admin
    from LynnRoBot.modules.sql import log_channel_sql as sql
    ...
    __help__ = """
*Admins only:*
 ☞︎︎︎ /logchannel*:* get log channel info
 ☞︎︎︎ /setlog*:* set the log channel.
 ☞︎︎︎ /unsetlog*:* unset the log channel.
