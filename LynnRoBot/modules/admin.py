...
from LynnRoBot import DRAGONS, dispatcher
...
from LynnRoBot.helper_extra.admin_rights import (
    user_can_pin,
    user_can_promote,
    user_can_changeinfo,
)
...
Here are some commands helpful for admins to manage groups
 ☞︎︎︎ /admins*:* list of admins in the chat
*Admins only:*
 ☞︎︎︎ /pin*:* silently pins the message replied to - add `'loud'` or `'notify'` to give notifs to users
 ☞︎︎︎ /unpin*:* unpins the currently pinned message
 ☞︎︎︎ /invitelink*:* gets invitelink
 ☞︎︎︎ /promote*:* promotes the user
 ☞︎︎︎ /demote*:* demotes the user
 ☞︎︎︎ /title <title here>*:* sets a custom title for an admin that the bot promoted
 ☞︎︎︎ /admincache*:* force refresh the admins list
 ☞︎︎︎ /antispam <on/off/yes/no>*:* Will toggle our antispam tech or return your current settings.
