...
import LynnRoBot.modules.sql.blsticker_sql as sql
from LynnRoBot import LOGGER, dispatcher
...
*NOTE:* Blacklist stickers do not affect the group admin
 ☞︎︎︎ /blsticker*:* See current blacklisted sticker
*Only admin:*
 ☞︎︎︎ /addblsticker <sticker link>*:* Add the sticker trigger to the black list. Can be added via reply sticker
 ☞︎︎︎ /unblsticker <sticker link>*:* Remove triggers from blacklist. The same newline logic applies here, so you can delete multiple triggers at once
 ☞︎︎︎ /rmblsticker <sticker link>*:* Same as above
 ☞︎︎︎ /blstickermode <ban/tban/mute/tmute>*:* sets up a default action on what to do if users use blacklisted stickers
Note:
 ☞︎︎︎ <sticker link> can be `https://t.me/addstickers/<sticker>` or just `<sticker>` or reply to the sticker message
"""
