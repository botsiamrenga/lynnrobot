...
from LynnRoBot import dispatcher, LOGGER, DRAGONS
...
from LynnRoBot.modules.helper_funcs.misc import build_keyboard_parser
from LynnRoBot.modules.helper_funcs.msg_types import get_filter_type
...
from LynnRoBot.modules.sql import cust_filters_sql as sql
...
__help__ = """
 ☞︎︎︎ /filters*:* List all active filters saved in the chat.
*Admin only:*
 ☞︎︎︎ /filter <keyword> <reply message>*:* Add a filter to this chat. The bot will now reply that message whenever 'keyword'\
 ...
 *Example:* 
 ...
 %%%
 Reply 3`
 ☞︎︎︎ /stop <filter keyword>*:* Stop that filter.
*Chat creator only:*
 ☞︎︎︎ /removeallfilters*:* Remove all chat filters at once.
*Note*: Filters also support markdown formatters like: {first}, {last} etc.. and buttons.
Check ☞︎︎︎ /markdownhelp to know more!
"""
